...
class Ui_RoundWidget(object):
    def setupUi(self, RoundWidget):
        ...
        self.button_erase_score = QPushButton(self.groupBox)
        self.button_erase_score.setObjectName(u"button_erase_score")
        icon = QIcon()
        icon.addFile(u":/icons/128x128/actions/edit-delete-2.png", QSize(), QIcon.Normal, QIcon.On)
        self.button_erase_score.setIcon(icon)
        self.button_erase_score.setIconSize(QSize(25, 25))

        self.horizontalLayout.addWidget(self.button_erase_score)

        self.button_random = QPushButton(self.groupBox)
        self.button_random.setObjectName(u"button_random")
        icon1 = QIcon()
        icon1.addFile(u":/icons/128x128/actions/roll-2.png", QSize(), QIcon.Normal, QIcon.On)
        self.button_random.setIcon(icon1)
        ...
        icon2 = QIcon()
        icon2.addFile(u":/css/60px-Nuvola_Swiss_flag.svg.png", QSize(), QIcon.Normal, QIcon.On)
        self.button_swiss.setIcon(icon2)
        ...
        icon3 = QIcon()
        icon3.addFile(u":/icons/128x128/actions/go-previous-9.png", QSize(), QIcon.Normal, QIcon.On)
        self.button_previous_round.setIcon(icon3)
        ...
        icon4 = QIcon()
        icon4.addFile(u":/icons/128x128/actions/go-next-9.png", QSize(), QIcon.Normal, QIcon.On)
        self.button_next_round.setIcon(icon4)
    ...
    def retranslateUi(self, RoundWidget):
        ...
        self.button_erase_score.setToolTip(QCoreApplication.translate("RoundWidget", u"Effacer les scores", None))
#endif // QT_CONFIG(tooltip)
        self.button_erase_score.setText("")
#if QT_CONFIG(tooltip)
