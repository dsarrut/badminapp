...
class Ui_MatchWidget(object):
    def setupUi(self, MatchWidget):
        ...
        self.label_field.setMinimumSize(QSize(75, 0))
        self.label_field.setMaximumSize(QSize(75, 16777215))
        font = QFont()
        ...
        self.label_field.setAlignment(Qt.AlignCenter)
        ...
        self.status1.setMinimumSize(QSize(0, 0))
        ...
        self.status2.setMinimumSize(QSize(0, 0))
